...
const App = ({advertisements, userIsStaff, lang, userPunishments}) => {
    ...
    return (
        <>
            <Head>
                <title>{cfg.siteName} - Premium</title>
    ...
    <meta property="og:color" content="#00ffad"/>
    ...
    <meta name="theme-color" content="#00ffad"/>
    ...
    <meta name="copyright" content="&copy; Anka List" />
            ...
            <div className="bg-discord-black-darker w-full h-full">
                ...
                <div className="text-center">
                    <a className="text-gray-100 no-underline text-2xl font-normal default-font p-4 md:px-10">{Lang("premium.text", lang)}</a>
                </div>
                <div className="py-1"></div>
                <div className="p-4 md:px-6">
                    <div className="flex flex-grow flex-wrap items-center justify-center">
                        {cfg.premiums.map((premium, i) => {
                            return (<PremiumCard lang={lang} description={premium.description} />);
                        })}
                    </div>
                </div>
