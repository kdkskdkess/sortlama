...
class App extends React.Component {
    ...
    return (
        <>
            <Head>
                <title>{cfg.siteName} - {Lang("staff.sidebar.certifiedBots", this.props.lang)}</title>
            </Head>
            <ToastContainer />
            <div className="min-h-screen flex flex-row flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
                ...
                <div className="bg-gray-900 h-screen w-screen px-16 md:px-64 p-6">
                    <div className="container mx-auto px-4 sm:px-8">
                        <div className="py-8">
                            <div>
                                <h2 className="text-2xl font-semibold leading-tight text-gray-200">{Lang("staff.certifiedbots.head", this.props.lang)}</h2>
                            </div>
                                        ...
                                        <thead>
                                            <tr>
                                                <th
                                                    ...
                                                    {Lang("staff.certifiedbots.name", this.props.lang)}
                                                </th>
                                                <th
                                                    className="px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider">
                                                    {Lang("staff.certifiedbots.owner", this.props.lang)}
                                                </th>
                                                <th
                                                    className="px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider">
                                                    {Lang("staff.certifiedbots.acts", this.props.lang)}
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                    ...
                                                    <div className="flex">
                                                        <div className="badge cursor-pointer">
                                                            <span className="px-2 ml-auto text-xs font-medium tracking-wide text-red-800 bg-blue-100 rounded-full" onClick={async(e) => {
                                                                ...
                                                                toast.success(Lang("staff.certifiedbots.deleted", this.props.lang), { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, draggable: true, progress: undefined, });
                                                                this.setState({bots: this.props.bots.filter((bott) => bott.id !== bot.id)})
                                                                this.props.bots = this.state.bots.filter((bott) => bott.id !== bot.id)
                                                            }}>{Lang("staff.certifiedbots.delete", this.props.lang)}</span>
                                                        </div>
                                                        <Link href={`/${this.props.lang}/bot/${bot.id}`}>
                                                        <div className="badge ml-2 cursor-pointer">
                                                            <span className="px-2 ml-auto text-xs font-medium tracking-wide text-blue-800 bg-blue-100 rounded-full">{Lang("staff.certifiedbots.view", this.props.lang)}</span>
                                                        </div>
                                                        </Link>
                                                        <div className="badge ml-2 cursor-pointer">
                                                            <span className="px-2 ml-auto text-xs font-medium tracking-wide text-green-800 bg-blue-100 rounded-full" onClick={async(e) => {
                                                                ...
                                                                toast.success(Lang("staff.certifiedbots.kicked", this.props.lang), { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, draggable: true, progress: undefined, })
                                                            }}>{Lang("staff.certifiedbots.kick", this.props.lang)}</span>
                                                        </div>
                                                        <div className="badge ml-2 cursor-pointer">
                                                            <span className="px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full" onClick={async(e) => {
                                                                await axios(cfg.siteURL+"/api/discord/ban", {
                                                                    method: "POST",
                                                                    headers: {
                                                                        'Accept': 'application/json',
                                                                        'Content-Type': 'application/json'
                                                                ...
                                                                toast.success(Lang("staff.certifiedbots.banned", this.props.lang), { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, draggable: true, progress: undefined, })
                                                            }}>{Lang("staff.certifiedbots.ban", this.props.lang)}</span>
                                                        </div>
                                                        <div className="badge ml-2 cursor-pointer">
                                                            <span className="px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full" onClick={async(e) => {
                                                                await axios(cfg.siteURL+"/api/bots/certificate", {
                                                                    method: "POST",
                                                                    headers: {
                                                                        'Accept': 'application/json',
                                                                        'Content-Type': 'application/json'
                                                                ...
                                                                toast.success(`${bot.certificate ? Lang("staff.certifiedbots.certificate.taken", this.props.lang) : Lang("staff.certifiedbots.certificate.given", this.props.lang)}.`, { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, draggable: true, progress: undefined, });
                                                            }}>{bot.certificate ? Lang("staff.certifiedbots.takeCertificate", this.props.lang) : Lang("staff.certifiedbots.giveCertificate", this.props.lang)}</span>
                                                        </div>
                                                        <div className="badge ml-2 cursor-pointer">
                                                            <span className="px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full" onClick={async(e) => {
                                                                await axios(cfg.siteURL+"/api/bots/specialurl", {
                                                                    method: "POST",
                                                                    headers: {
                                                                        'Accept': 'application/json',
                                                                        'Content-Type': 'application/json'
                                                                ...
                                                                toast.success(`${bot.specialURL ? Lang("staff.certifiedbots.specialURL.taken", this.props.lang) : Lang("staff.certifiedbots.specialURL.given", this.props.lang)}.`, { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, draggable: true, progress: undefined, });
                                                            }}>{bot.specialURL ? Lang("staff.certifiedbots.takeSpecialURL", this.props.lang) : Lang("staff.certifiedbots.giveSpecialURL", this.props.lang)}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>)
