        ...
        <>
            ...
            <div className="p-8">
                <div className="px-4" align="center">
                    ...
                    <a className="text-gray-100 no-underline text-4xl font-bold">Anka Bot List</a>
                    <div className="py-0.5"></div>
                    <a className="text-gray-300 no-underline text-md">{Lang("tags.section", this.props.lang)}</a>
                    <div className="py-3"></div>
                    <div className="flex justify-center">
                        <input onChange={(e) => {
                                        this.setState({bots: this.props.bots.filter((bot) => bot.tags.includes(router.query.tag)).filter((bot) => bot.bot.name.toLowerCase().includes(e.target.value.toLowerCase()))})
                    ...
                    {Object.keys(Lang("bot.tags", this.props.lang)).map((tag) => {
                        return (
                            <a href={`/${this.props.lang}/bots/tag/${Lang("bot.tags", this.props.lang)[tag]}`}>
                                <div className="mt-2">
            ...
            <div className="bg-discord-black-darker w-full h-full">
                ...
                <div className="p-4 md:px-6">
                    <div className="flex flex-grow flex-wrap items-center justify-center">
                        {this.state.bots.filter((bot) => bot.tags.includes(router.query.tag)).sort((a, b) => { return (b.votes || 0) - (a.votes || 0); }).map((bot, i) => {
