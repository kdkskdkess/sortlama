                ...
                <div className="md:flex md:flex-wrap flex-row-reverse md:flex-row">
                    <div className="w-full mx-auto h-full bg-discord-black rounded-md shadow-lg p-4 py-4">
                        <div className="flex flex-grow flex-wrap p-4 justify-center md:justify-start">
                            <div className="md:ml-0 w-2/4">
                                <label className="text-white text-sm font-semibold">{Lang("addcode.labels.name", this.props.lang)} <a className="text-red-500">*</a></label>
                                <div className="flex">
                                    ...
                                    <input onChange={(e) => this.setState({codename: e.target.value})} className="w-full md:w-96 px-2 bg-input rounded-r-md text-white border border-transparent focus:outline-none focus:border-transparent" placeholder="..." />
                                </div>
                            </div>
                            <div className="mt-2 w-2/4">
                                ...
                                <div className="flex">
                                    ...
                                    <input onChange={(e) => this.setState({codedesc: e.target.value})} className="w-full px-2 bg-input rounded-r-md text-white border border-transparent focus:outline-none focus:border-transparent" />
                                </div>
                            </div>
                            <div className="w-full h-48 mt-2" align="center">
                                ...
                                <textarea onKeyUp={(e) => this.setState({code: e.target.value})} resizable={false} className="w-full h-48 p-4 bg-input resize-none rounded-md text-white border border-transparent focus:outline-none focus:border-transparent" />
                            </div>
                            <div className="w-full h-48 mt-8" align="center">
                                <label className="text-white text-sm font-semibold">bot.js</label>
                                <textarea onKeyUp={(e) => this.setState({codeMain: e.target.value})} resizable={false} className="w-full h-48 p-4 bg-input resize-none rounded-md text-white border border-transparent focus:outline-none focus:border-transparent" />
                            </div>
                            <div align="center">
                        ...
                        <div className="flex items-center justify-center">
                            <a className="text-center flex-no-grow flex-no-shrink relative text-lg py-2 px-4 ml-2 leading-normal text-white no-underline flex items-center transition duration-200 hover:bg-discord-black border-2 border-discord-black cursor-pointer" onClick={async(e) => {
                                ...
                                if(d.error && d.error === 2) {
                                    return toast.error(Lang("addcode.messages.theresCode", this.props.lang), { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, draggable: true, progress: undefined, });
                                ...
                                toast.success(Lang("addcode.messages.success", this.props.lang), { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, draggable: true, progress: undefined, });
