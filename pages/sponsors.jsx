...
const App = ({advertisements, userIsStaff, lang, userPunishments}) => {
    ...
    return (
        <>
            <Head>
                <title>{cfg.siteName} - {Lang("navbar.sponsors", lang)}</title>
    ...
    <meta property="og:color" content="#79ff00"/>
    ...
    <meta name="theme-color" content="#79ff00"/>
    ...
    <meta name="copyright" content="&copy; Anka List" />
            ...
            <div className="bg-discord-black-darker w-full h-full">
                ...
                <div className="text-center">
                    <a className="text-gray-100 no-underline text-2xl font-normal default-font p-4 md:px-10">{Lang("sponsors.text", lang)}</a>
                </div>
