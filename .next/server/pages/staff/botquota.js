...
/* harmony import */ var _schemas_BotAddQuota__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5881);
/* harmony import */ var _schemas_BotAddQuota__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_schemas_BotAddQuota__WEBPACK_IMPORTED_MODULE_6__);
...
class App extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_10___default()), null, __jsx("title", null, cfg.siteName, " - ", _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.sidebar.addBotQuota", this.props.lang))), __jsx(react_toastify__WEBPACK_IMPORTED_MODULE_7__.ToastContainer, null), __jsx("div", {
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.head", this.props.lang))), __jsx("div", {
      className: "py-2"
    }), __jsx("h2", {
      className: "text-sm font-semibold leading-tight text-gray-200"
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.addQuota", this.props.lang)), __jsx("div", {
      ...
      selected: true,
      disabled: true
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.selectRole", this.props.lang), "."), this.props.server.roles.sort((a, b) => b.position - a.position).map(role => {
      return __jsx("option", {
        value: role.id,
      ...
      placeholder: _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.botNumber", this.props.lang),
      type: "number",
      className: "w-full py-2 px-2 bg-input rounded-md text-white border border-transparent focus:outline-none focus:border-transparent"
    })), __jsx("div", {
      ...
      onClick: async e => {
        if (this.state.role.length === 0 || this.state.number.length === 0) {
          return react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast.error(_language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.fillEverything", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
        ...
        var d = await axios__WEBPACK_IMPORTED_MODULE_4___default()(cfg.siteURL + "/api/addbotquotarole", {
          method: "POST",
          headers: {
        ...
        if (d.error === 2) {
          return react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast.error(_language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.alreadyAdded", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
        ...
        react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast.success(_language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.added", this.props.lang), {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: true,
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.role", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.number", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.acts", this.props.lang)))), __jsx("tbody", null, this.props.quota.map((role, i) => {
      var nRole = this.props.server.roles.filter(r => r.id === role.id)[0];

      if (!nRole) {
        nRole = {
          name: _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.deletedRole", this.props.lang),
          number: role.id
        };
      }
      ...
      return __jsx("tr", {
        ...
        onClick: async e => {
          ...
          return react_toastify__WEBPACK_IMPORTED_MODULE_7__.toast.success(_language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.deleted", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_9___default()("staff.botquota.delete", this.props.lang))))));
    }))))))))));
  }
...
async function getServerSideProps(ctx) {
  var quota = await _schemas_BotAddQuota__WEBPACK_IMPORTED_MODULE_6___default().find({});
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,4730], function() { return __webpack_exec__(9188); });
