...
class App extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_9___default()), null, __jsx("title", null, cfg.siteName, " - ", _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.sidebar.approvedBots", this.props.lang))), __jsx(react_toastify__WEBPACK_IMPORTED_MODULE_6__.ToastContainer, null), __jsx("div", {
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.head", this.props.lang))), __jsx("div", {
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.name", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.owner", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.acts", this.props.lang)))), __jsx("tbody", null, this.state.bots ? this.state.bots.sort(function (a, b) {
      ...
      return __jsx("tr", null, __jsx("td", {
        ...
        onClick: async e => {
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.deleted", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.delete", this.props.lang))), __jsx(next_link__WEBPACK_IMPORTED_MODULE_3__.default, {
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.view", this.props.lang)))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        ...
        onClick: async e => {
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.kicked", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.kick", this.props.lang))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        ...
        onClick: async e => {
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.banned", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.ban", this.props.lang))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        className: "px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full",
        onClick: async e => {
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(`${bot.certificate ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.certificate.taken", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.certificate.given", this.props.lang)}.`, {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, bot.certificate ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.takeCertificate", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.giveCertificate", this.props.lang))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        className: "px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full",
        onClick: async e => {
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(`${bot.specialURL ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.specialURL.taken", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.specialURL.given", this.props.lang)}.`, {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, bot.specialURL ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.takeSpecialURL", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.bots.giveSpecialURL", this.props.lang))))));
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,4730], function() { return __webpack_exec__(1494); });
