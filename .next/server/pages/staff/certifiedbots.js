...
class App extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_9___default()), null, __jsx("title", null, cfg.siteName, " - ", _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.sidebar.certifiedBots", this.props.lang))), __jsx(react_toastify__WEBPACK_IMPORTED_MODULE_6__.ToastContainer, null), __jsx("div", {
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.head", this.props.lang))), __jsx("div", {
      ...
      placeholder: _language__WEBPACK_IMPORTED_MODULE_8___default()("botPlaceholder", this.props.lang),
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.name", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.owner", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.acts", this.props.lang)))), __jsx("tbody", null, this.state.bots ? this.state.bots.sort(function (a, b) {
      ...
      return __jsx("tr", null, __jsx("td", {
        ...
        onClick: async e => {
          await fetch(cfg.siteURL + "/api/bots/remove", {
            method: "POST",
            headers: {
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.deleted", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.delete", this.props.lang))), __jsx(next_link__WEBPACK_IMPORTED_MODULE_3__.default, {
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.view", this.props.lang)))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        className: "px-2 ml-auto text-xs font-medium tracking-wide text-green-800 bg-blue-100 rounded-full",
        onClick: async e => {
          await axios__WEBPACK_IMPORTED_MODULE_5___default()(cfg.siteURL + "/api/discord/kick", {
            method: "POST",
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json'
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.kicked", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.kick", this.props.lang))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        className: "px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full",
        onClick: async e => {
          await axios__WEBPACK_IMPORTED_MODULE_5___default()(cfg.siteURL + "/api/discord/ban", {
            method: "POST",
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json'
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.banned", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.ban", this.props.lang))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        className: "px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full",
        onClick: async e => {
          await axios__WEBPACK_IMPORTED_MODULE_5___default()(cfg.siteURL + "/api/bots/certificate", {
            method: "POST",
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json'
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(`${bot.certificate ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.certificate.taken", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.certificate.given", this.props.lang)}.`, {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, bot.certificate ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.takeCertificate", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.giveCertificate", this.props.lang))), __jsx("div", {
        className: "badge ml-2 cursor-pointer"
      }, __jsx("span", {
        className: "px-2 ml-auto text-xs font-medium tracking-wide text-gray-800 bg-blue-100 rounded-full",
        onClick: async e => {
          await axios__WEBPACK_IMPORTED_MODULE_5___default()(cfg.siteURL + "/api/bots/specialurl", {
            method: "POST",
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json'
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(`${bot.specialURL ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.specialURL.taken", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.specialURL.given", this.props.lang)}.`, {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, bot.specialURL ? _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.takeSpecialURL", this.props.lang) : _language__WEBPACK_IMPORTED_MODULE_8___default()("staff.certifiedbots.giveSpecialURL", this.props.lang))))));
...
async function getServerSideProps(ctx) {
  ...
  return {
    props: {
      user,
      bots: JSON.stringify(bots.filter(bot => bot.waiting === false && bot.certificate === true)),
      userIsStaff,
      userIsAdmin,
      lang: ctx.locale
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,4730], function() { return __webpack_exec__(7873); });
