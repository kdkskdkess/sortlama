...
class App extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_8___default()), null, __jsx("title", null, cfg.siteName, " - ", _language__WEBPACK_IMPORTED_MODULE_7___default()("staff.sidebar.waitingCodes", this.props.lang))), __jsx(react_toastify__WEBPACK_IMPORTED_MODULE_6__.ToastContainer, null), __jsx("div", {
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.head", this.props.lang))), __jsx("div", {
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.name", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.owner", this.props.lang)), __jsx("th", {
      className: "px-5 py-3 bg-input text-left text-xs font-semibold text-gray-200 uppercase tracking-wider"
    }, _language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.acts", this.props.lang)))), __jsx("tbody", null, this.state.codes ? this.state.codes.sort(function (a, b) {
      ...
      return __jsx("tr", {
        ...
        onClick: async e => {
          ...
          if (d.error === 3) {
            return react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.error(_language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.regularly", this.props.lang), {
              position: "top-right",
              autoClose: 5000,
          ...
          if (d.error === 5) {
            return react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.error(_language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.youDontHavePermission", this.props.lang), {
              position: "top-right",
              autoClose: 5000,
              hideProgressBar: false,
              closeOnClick: true,
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.deleted", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
          ...
          this.setState({
            codes: this.props.codes.filter(codee => codee.name !== code.name)
          });
          this.props.codes = this.state.codes.filter(codee => codee.name !== code.name);
        }
      }, _language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.delete", this.props.lang))), __jsx("div", {
        ...
        onClick: async e => {
          var d = await axios__WEBPACK_IMPORTED_MODULE_4___default()(cfg.siteURL + "/api/codes/approve", {
            method: "POST",
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json'
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(_language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.approved", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      }, _language__WEBPACK_IMPORTED_MODULE_7___default()("staff.waitingcodes.approve", this.props.lang))), __jsx(next_link__WEBPACK_IMPORTED_MODULE_3__.default, {
...
async function getServerSideProps(ctx) {
  ...
  return {
    props: {
      user,
      codes: JSON.stringify(codes.filter(code => code.waiting === true)),
      userIsStaff,
      userIsAdmin,
      lang: ctx.locale
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,4730], function() { return __webpack_exec__(4033); });
