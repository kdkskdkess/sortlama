...
/* harmony import */ var _schemas_Codes__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(3191);
/* harmony import */ var _schemas_Codes__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_schemas_Codes__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var _Components_Navbar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1459);
/* harmony import */ var _Components_Footer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(8660);
...
class App extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_1___default()), null, __jsx("title", null, cfg.siteName, " - ", _language__WEBPACK_IMPORTED_MODULE_9___default()("navbar.user.addcode", this.props.lang)), __jsx("meta", {
      property: "og:url",
    ...
    })), __jsx(_Components_Navbar__WEBPACK_IMPORTED_MODULE_10__/* .default */ .Z, {
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.labels.desc", this.props.lang), " ", __jsx("a", {
      ...
      className: "text-white text-sm font-semibold"
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.labels.code", this.props.lang), " ", __jsx("a", {
      className: "text-red-500"
    }, "*")), __jsx("textarea", {
      name: "commands",
      id: "commands",
      ...
      className: "text-white text-sm font-semibold"
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.labels.library", this.props.lang), " ", __jsx("a", {
      className: "text-red-500"
    }, "*")), __jsx("div", {
      className: "flex"
    }, __jsx("a", {
      ...
      return __jsx("option", {
        key: i,
        value: el,
        selected: this.state.codelibrary === el
      }, el);
    })))), __jsx("div", {
      className: "md:ml-4 mt-8"
    }, __jsx("label", {
      className: "text-white text-sm font-semibold"
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.labels.tags", this.props.lang), " ", __jsx("a", {
      className: "text-red-500"
    }, "*")), __jsx("div", {
      className: "flex"
    }, __jsx("a", {
      ...
      return __jsx("option", {
        key: i,
        value: el,
        selected: this.state.codecategories.includes(el)
      }, el);
    }))))), __jsx("div", {
      ...
      onClick: async e => {
        if (!this.props.settings.botAdd) {
          return react_toastify__WEBPACK_IMPORTED_MODULE_3__.toast.error(_language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.messages.cantadd", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
        ...
        if (data.codename.length === 0 || data.codedesc.length === 0 || data.codelibrary.length === 0 || data.codecategories.length === 0 || data.code.length === 0) {
          return react_toastify__WEBPACK_IMPORTED_MODULE_3__.toast.error(_language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.messages.insufficient", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
        ...
        if (data.codecategories.length > 6) {
          return react_toastify__WEBPACK_IMPORTED_MODULE_3__.toast.error(`${_language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.messages.tags", this.props.lang)} (${data.bottags.length})`, {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
        ...
        try {
          ...
          console.log(err);
          return react_toastify__WEBPACK_IMPORTED_MODULE_3__.toast.error(_language__WEBPACK_IMPORTED_MODULE_9___default()("error", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
        ...
        if (d.error && d.error === 3) {
          return react_toastify__WEBPACK_IMPORTED_MODULE_3__.toast.error(_language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.messages.notInDiscord", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
          ...
          return react_toastify__WEBPACK_IMPORTED_MODULE_3__.toast.error(_language__WEBPACK_IMPORTED_MODULE_9___default()("addcode.messages.punished", this.props.lang), {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
        ...
        react_toastify__WEBPACK_IMPORTED_MODULE_3__.toast.success(_language__WEBPACK_IMPORTED_MODULE_9___default()("editcode.messages.success", this.props.lang), {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: true,
    ...
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("send", this.props.lang)))))), __jsx(_Components_Footer__WEBPACK_IMPORTED_MODULE_11__/* .default */ .Z, {
      lang: this.props.lang
    }));
  }
...
async function getServerSideProps(ctx) {
  ...
  var code = await _schemas_Codes__WEBPACK_IMPORTED_MODULE_8___default().findOne({
    name: ctx.params.id
  });
  ...
  if (!code) {
    next_redirect__WEBPACK_IMPORTED_MODULE_4___default()(ctx, '/');
    return {};
  }
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,2079], function() { return __webpack_exec__(5271); });
