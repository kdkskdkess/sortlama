...
class App extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_1___default()), null, __jsx("title", null, (_config_js__WEBPACK_IMPORTED_MODULE_10___default().siteName), " - ", _language__WEBPACK_IMPORTED_MODULE_9___default()("navbar.bots", this.props.lang)), __jsx("meta", {
      property: "og:title",
      content: "Dark List"
    }), __jsx("meta", {
      property: "og:type",
    ...
    }, (_config_js__WEBPACK_IMPORTED_MODULE_10___default().siteName)), __jsx("div", {
      className: "py-0.5"
    }), __jsx("a", {
      className: "text-gray-300 no-underline text-md"
    }, _language__WEBPACK_IMPORTED_MODULE_9___default()("bots.section", this.props.lang)), __jsx("div", {
      className: "py-3"
    }), __jsx("div", {
      ...
      return __jsx(next_link__WEBPACK_IMPORTED_MODULE_8__.default, {
        href: `/${this.props.lang}/bots/tag/${tag}`
      }, __jsx("div", {
        className: "mt-2"
      }, __jsx("a", {
    ...
    }, (this.state.searchBot.length >= 1 ? this.state.bots : this.state.bots.filter(bot => bot.bot.name.toLowerCase().includes((router.query.name || "").toLowerCase()))).sort((a, b) => {
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,2079,7340], function() { return __webpack_exec__(1365); });
