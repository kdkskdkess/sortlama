...
const App = ({
  ...
  return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_1___default()), null, __jsx("title", null, cfg.siteName, " - ", _language__WEBPACK_IMPORTED_MODULE_7___default()("navbar.sponsors", lang)), __jsx("meta", {
    property: "og:title",
  ...
  }, _language__WEBPACK_IMPORTED_MODULE_7___default()("sponsors.text", lang))), __jsx("div", {
    className: "py-1"
  }), __jsx("div", {
    className: "p-4 md:px-6"
  }, __jsx("div", {
    className: "flex flex-grow flex-wrap items-center justify-center"
  }, cfg.sponsors.map((sponsor, i) => {
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,2079,6582], function() { return __webpack_exec__(3132); });
