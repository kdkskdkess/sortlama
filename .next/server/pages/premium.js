...
const App = ({
  ...
  return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_1___default()), null, __jsx("title", null, cfg.siteName, " - Premium"), __jsx("meta", {
    property: "og:title",
  ...
  }, _language__WEBPACK_IMPORTED_MODULE_7___default()("premium.text", lang))), __jsx("div", {
    className: "py-1"
  }), __jsx("div", {
    className: "p-4 md:px-6"
  }, __jsx("div", {
    className: "flex flex-grow flex-wrap items-center justify-center"
  }, cfg.premiums.map((premium, i) => {
    return __jsx(_Components_PremiumCard__WEBPACK_IMPORTED_MODULE_9__/* .default */ .Z, {
      lang: lang,
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,2079,4571], function() { return __webpack_exec__(351); });
