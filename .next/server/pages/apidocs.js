...
const App = ({
  ...
  return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_1___default()), null, __jsx("title", null, cfg.siteName, " - API"), __jsx("meta", {
    property: "og:url",
    ...
    className: "p-8 md:p-36bg-discord-black w-full h-full"
  }, __jsx("div", {
    className: "p-4"
  }), __jsx("div", {
  ...
  }, _language__WEBPACK_IMPORTED_MODULE_7___default()("apidocs.head", lang))), __jsx("div", {
    className: "py-1"
  }), __jsx("div", {
    ...
    dangerouslySetInnerHTML: {
      __html: _language__WEBPACK_IMPORTED_MODULE_7___default()("apidocs.text", lang).split("\n").join("<br/>")
    }
  })), __jsx("div", {
    className: "p-2"
  }), __jsx("a", {
    className: "text-gray-200 no-underline"
  }, __jsx("code", null, __jsx("div", {
    className: "text-white",
    dangerouslySetInnerHTML: {
      __html: _language__WEBPACK_IMPORTED_MODULE_7___default()("apidocs.usage", lang).split("\n").join("<br/>")
    }
  })))), __jsx("div", {
    className: "p-8"
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,2079], function() { return __webpack_exec__(4513); });
