...
class App extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    return __jsx((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, __jsx((next_head__WEBPACK_IMPORTED_MODULE_1___default()), null, __jsx("title", null, (_config_js__WEBPACK_IMPORTED_MODULE_11___default().siteName), " - ", _language__WEBPACK_IMPORTED_MODULE_10___default()("navbar.codes", this.props.lang)), __jsx("meta", {
      property: "og:title",
      content: "Dark List"
    }), __jsx("meta", {
      property: "og:type",
    ...
    }, (_config_js__WEBPACK_IMPORTED_MODULE_11___default().siteName)), __jsx("div", {
      className: "py-0.5"
    }), __jsx("a", {
      className: "text-gray-300 no-underline text-md"
    }, _language__WEBPACK_IMPORTED_MODULE_10___default()("codes.section", this.props.lang)), __jsx("div", {
      className: "py-3"
    }), __jsx("div", {
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4985,7813,2079,8977], function() { return __webpack_exec__(1839); });
